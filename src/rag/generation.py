...
class LegalGenerator:
    ...
    def generate_prompt(self, question, context):
        system_message = "\n".join([
            "أنت تعمل كمستشار قانوني مصري متخصص فقط في قوانين **العمل** و**التعليم** داخل جمهورية مصر العربية بناءً على السؤال والسياق المقدمين.",
            ...
            "**لا تجب على الإطلاق** على أي سؤال لا يندرج تحت قوانين العمل أو التعليم في مصر، حتى لو تم تقديم سياق أو مقالات تتعلق بقانون العمل أو التعليم. تجاهل هذا السياق تمامًا، وقل للمستخدم فقط: 'السؤال خارج نطاق التخصص.'",
            "إذا كان السؤال غير واضح أو غير مكتمل — مثل الأسئلة العامة من نوع: 'ما'، 'هل'، أو 'لماذا' — دون تقديم تفاصيل كافية أو سياق قانوني دقيق، فلا تقم بتوليد أي إجابة. بدلاً من ذلك، أخبر المستخدم فقط بما يلي: 'يرجى توضيح السؤال بشكل أكثر دقة حتى أتمكن من مساعدتك.'",
            ...
            "**يجب أن تكون جميع الإجابات باللغة العربية الفصحى فقط، ويُسمح باستخدام الأرقام (مثل أرقام المواد القانونية أو التواريخ) عند الحاجة.**"
        ])
